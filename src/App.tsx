...
function App() {
  useEffect(() => {
    ...
    const handleResize = () => {
      if ($(window).width() <= 768) {
        $('.slider div').each(function (this: HTMLElement) {
          $(this).css('background-image', 'url(' + $(this).data('mobile') + ')');
        });
      } else {
        $('.slider div').each(function (this: HTMLElement) {
          $(this).css('background-image', 'url(' + $(this).data('pc') + ')');
        });
      }
    };
        ...
        <div id="visual">
          <div className="slider">
            <div
              ...
              data-pc="/upload/banner/banner_file_202308222942917.png"
              data-mobile="/upload/banner/banner_file_202308222639832.png"
            />
          </div>
        </div>
            ...
            <div className="box_type01">
              ...
              <div className="box_cont bg_img01">
                <div>
                  ...
                  <p>
                    EAP 프로그램은 개인의 정신 건강과 건강한 기업문화을 기반으로
                    조직문화 증진 및 생산성 향상을 목적으로 한 기업의 정신건강관리
                    프로그램 입니다.
                  </p>
                  <a href="/eap.do">More</a>
                </div>
              </div>
              ...
              <div className="box_cont bg_img02">
                <div>
                  ...
                  <p>
                    심리상담, 심리검사, 코칭 등 다양한 프로그램으로 고객들이
                    원하는 서비스를 제공하고 있습니다.
                  </p>
                  <a href="/counseling.do">More</a>
                </div>
              </div>
              ...
              <div className="box_cont bg_img03">
                <div>
                  ...
                  <p>
                    이 과정은 사람의 마음을 온전히 이해하고자 노력하고, 건강하게
                    회복하도록 돕고자 자신의 삶을 결정한 전문상담사들의 교육
                    과정입니다.
                  </p>
                  <a href="/education.do">More</a>
                </div>
              </div>
            </div>
